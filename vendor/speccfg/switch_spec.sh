...
#/*BEGIN PN: DTS2014012606754, delete by l00173070, 2014/2/13*/#
#/*END PN: DTS2014012606754, delete by l00173070, 2014/2/13*/#
createFolder()
{
  local dirPath=$1
  if [ -d "$dirPath" ]
...
then
  ...
  then
    ...
    then
      ...
      #/*BEGIN PN: DTS2014012606754, modified by l00173070, 2014/2/13*/#
      ParseFile "$strVendorPath/$CurSpec/data" "/install"
      #/*END PN: DTS2014012606754, modified by l00173070, 2014/2/13*/#
      echo "" > "$strDataFolder/install_flag"
    fi
  else
    installSpec
